...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _DOM__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./DOM */ \"./src/DOM.js\");\n/* harmony import */ var _weatherapi__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./weatherapi */ \"./src/weatherapi.js\");\n\n\n\n//select submit button and information div\nlet submit = document.getElementById(\"submit\");\nlet info = document.getElementById(\"information\");\n//Get Data for the requisted city\nfunction handleSubmit(e) {\n    e.preventDefault();\n    //Clear previous data on the screen\n    (0,_DOM__WEBPACK_IMPORTED_MODULE_1__.clearNode)(info);\n    //Get city name from the search box and then get the data for that city\n    let city = document.getElementById(\"searchBox\").value;\n    (0,_weatherapi__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(city).then(data => {\n        //If the response is not valid, display the error message\n        if (typeof data === \"string\") {\n            (0,_DOM__WEBPACK_IMPORTED_MODULE_1__.newElement)(\"div\",\"error\", info, data);\n            return;\n        }\n        //Display the data on the screen\n        (0,_DOM__WEBPACK_IMPORTED_MODULE_1__.newElement)(\"div\",\"name\", info, data.name);\n        (0,_DOM__WEBPACK_IMPORTED_MODULE_1__.newElement)(\"div\",\"country\", info, data.country);\n        (0,_DOM__WEBPACK_IMPORTED_MODULE_1__.newElement)(\"div\",\"localTime\", info, data.localtime);\n        (0,_DOM__WEBPACK_IMPORTED_MODULE_1__.newElement)(\"div\",\"condition\", info, data.text);\n        (0,_DOM__WEBPACK_IMPORTED_MODULE_1__.newElement)(\"div\",\"lastUpdated\", info, data.last_updated);\n        let tempeture = (0,_DOM__WEBPACK_IMPORTED_MODULE_1__.newElement)(\"div\",\"tempeture\", info, data.temp_c + \" °C\");\n        let currentTemp = data.temp_c\n        let otherTemp = data.temp_f\n        tempeture.addEventListener(\"click\", () => {\n            [currentTemp, otherTemp] = (0,_DOM__WEBPACK_IMPORTED_MODULE_1__.toggleTemp)(currentTemp, otherTemp);\n        });\n        (0,_DOM__WEBPACK_IMPORTED_MODULE_1__.changeBackground)(data.temp_c);\n    });\n}\nsubmit.addEventListener(\"click\", handleSubmit);\n\n\n//# sourceURL=webpack://weatherapp/./src/index.js?");
